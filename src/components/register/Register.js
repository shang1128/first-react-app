    ...
    return(
        ...
        <div className="content-container">
            ...
            <div className="logform">
               ...
               <input onChange={onChangeFullName} value={fullName} type="text" className="input-email" />
                ...
                <input onChange={onChangePassword} value={password} type={togglePass ? "password" : "text"} id="password" className={`in-password ${minPassword ? 'red' : 'green' }`} placeholder="Must be at least 6 characters" />
